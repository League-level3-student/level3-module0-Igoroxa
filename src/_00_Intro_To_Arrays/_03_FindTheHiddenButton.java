...
String number = JOptionPane.showInputDialog("Enter Positive Number");
...
JOptionPane.showMessageDialog(null, "Find the button which that is secret!");
...
if (buttonClicked == buttons[hiddenButton]) {
	JOptionPane.showMessageDialog(null, "Congratulations! You have found the hidden Button");
}
